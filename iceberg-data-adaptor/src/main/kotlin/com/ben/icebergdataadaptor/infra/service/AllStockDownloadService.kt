...
class AllStockDownloadService {
	...
	fun downAllStock(day: String? = null) {
		try {
			...
			var cmd =
				"python3 /Users/wangpeng/Documents/code/test-code/ice/iceberg-data-adaptor/src/main/kotlin/com/ben/icebergdataadaptor/infra/py/testAllStockInfo.py ${WebHookUrl.BAO_STOCK_ALL_STOCK_CODE}"
			day?.let { cmd = "$cmd $day" }
