...
class StockIndustryService {
    ...
    fun industry() {
        val cmd = "python3 /Users/wangpeng/Documents/my-hobbit/hobbit-code/ice/iceberg-data-adaptor/src/main/kotlin/com/ben/icebergdataadaptor/infra/py/StockIndustry.py ${WebHookUrl.BAO_STOCK_INDUSTRY}"
        try {
